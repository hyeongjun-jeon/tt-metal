...
std::vector<Tensor> fold_with_transpose_(
    ...
    if (output_shape.has_value()) {
        ...
        auto slice_output = ttnn::slice(transpose_hc_output2, slice_output_tensor_start, slice_output_tensor_end, std::nullopt, L1_mem_config, std::nullopt);
...
std::vector<Tensor> fold_with_transpose_sharded_(
    ...
    if (output_shape.has_value()) {
        ...
        tt_output_tensor = ttnn::slice(tt_output_tensor, slice_output_tensor_start, slice_output_tensor_end, std::nullopt, slice_mem_config, std::nullopt);
