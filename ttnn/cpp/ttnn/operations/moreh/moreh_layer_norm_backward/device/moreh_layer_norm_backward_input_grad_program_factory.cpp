...
MorehLayerNormBackwardInputGradOperation::ProgramFactory::create(
    ...
    // const tt::tt_metal::Tensor& input_grad = output_tensors.at(0);
    const std::optional<const Tensor> input_grad = output_tensors.at(0);
...
void MorehLayerNormBackwardInputGradOperation::ProgramFactory::override_runtime_arguments(
    ...
    auto input_grad_buffer = tensor_return_value.at(0)->buffer();
