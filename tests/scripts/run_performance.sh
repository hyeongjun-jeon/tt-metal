...
run_perf_models_other() {
    ...
    env pytest -n auto models/experimental/functional_mnist/tests/test_perf_mnist.py -m $test_marker
...
run_device_perf_models() {
    ...
    env pytest models/experimental/functional_mnist/tests/ -m $test_marker
