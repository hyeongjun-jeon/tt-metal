...
run_perf_models_other() {
    ...
    env pytest - auto models/experimental/functional_convnet_mnist/tests -m $test_marker
...
run_device_perf_models() {
    ...
    env pytest models/experimental/functional_convnet_mnist/tests/ -m $test_marker
