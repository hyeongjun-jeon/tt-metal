...
class tt_hlk_desc {
   ...
   public:
    ...
    DataFormat get_input_buf_dataformat(int buf_idx) const { return input_buf_dataformat_arr[buf_idx]; }

    void set_input_buf_dataformat(int buf_idx, DataFormat data_format) {
        input_buf_dataformat_arr[buf_idx] = data_format;
    }

    DataFormat get_param_buf_dataformat(int buf_idx) const { return param_buf_dataformat_arr[buf_idx]; }

    void set_param_buf_dataformat(int buf_idx, DataFormat data_format) {
        param_buf_dataformat_arr[buf_idx] = data_format;
    }

    DataFormat get_output_buf_dataformat(int buf_idx) const { return output_buf_dataformat_arr[buf_idx]; }

    void set_output_buf_dataformat(int buf_idx, DataFormat data_format) {
        output_buf_dataformat_arr[buf_idx] = data_format;
    }

    DataFormat get_intermediate_buf_dataformat(int buf_idx) const { return intermediate_buf_dataformat_arr[buf_idx]; }
    ...
    const DataFormat* get_input_buf_dataformats() const { return input_buf_dataformat_arr; }

    const DataFormat* get_param_buf_dataformats() const { return param_buf_dataformat_arr; }

    const DataFormat* get_output_buf_dataformats() const { return output_buf_dataformat_arr; }

    const DataFormat* get_intermediate_buf_dataformats() const { return intermediate_buf_dataformat_arr; }
};  // tt_hlk_desc
}  // namespace tt
