...
from models.experimental.functional_mnist.tt import tt_functional_mnist
...
def test_performance_mnist(device, batch_size, functional_mnist, model_location_generator):
